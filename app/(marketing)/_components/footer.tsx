        ...
        <div className="order-1 mb-12 flex flex-1 flex-col flex-wrap gap-6 md:flex-row lg:order-2 lg:mb-0 lg:justify-end lg:gap-24">
          <div>
            ...
            <ul className="flex flex-col gap-2">
              ...
              <li>
                <Link  color="foreground" href="/#mission">
                  Mission
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              ...
              <li>
                <Link color="foreground" href={siteConfig.twitter}>
                  Twitter
                </Link>
              </li>
              <li>
                <Link color="foreground" href={siteConfig.discord}>
                  Discord
                </Link>
              </li>
              <li>
                <Link color="foreground" href={siteConfig.instagram}>
                  Instagram
                </Link>
              </li>
            </ul>
